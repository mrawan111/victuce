-- Migration: Add production-ready features
-- Date: Latest
-- Description: Adds idempotency keys, refresh tokens, and role support
...
-- Add cleanup function for expired idempotency keys (optional, can be run via scheduled job)
-- This is just a helper, actual cleanup should be done via application logic or cron
